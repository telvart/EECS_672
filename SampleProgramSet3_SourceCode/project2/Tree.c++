...
{
	numPoints = 2;
	vec3 verticies[2] = {{0, 0, 0}, {20, 20, 20}};
	vec3 normals[2] = {{0.5,0.5,0.5}, {1,1,1}};
	...
	int bufferSize = numPoints * sizeof(vec3);
...
void Tree::render()
{
	...
	glUniformMatrix4fv(shaderIF->ppuLoc("mc_ec"), 1, false, ec_lds.extractColMajor(mat));
