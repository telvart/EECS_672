...
void TreeTop::defineTreeTop()
{
	...
	std::cout<<"totalPoints = "<<totalPoints<<"\n";
	...
	//std::cout<<"39: ("<<verticies[39][0]<<", "<<verticies[39][1]<<", "<<verticies[39][2]<<")\n";
	//std::cout<<"40: ("<<verticies[40][0]<<", "<<verticies[40][1]<<", "<<verticies[40][2]<<")\n";
